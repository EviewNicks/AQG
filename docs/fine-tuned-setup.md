...
Dari paper Houlsby et al. (2019), untuk model 248M parameters:

| Dimension (d) | Trainable Params | Performance | Memory | Recommended |
|---------------|-----------------|-------------|--------|-------------|
| **32** | 2.2M (0.9%) | 95% | 10GB | ❌ Terlalu kecil |
| **64** | 4.4M (1.8%) | 98% | 12GB | ✅ OPTIMAL |
| **128** | 8.9M (3.6%) | 99.6% | 14GB | ⚠️ Bisa, tapi overkill |
| **256** | 17.8M (7.2%) | 99.8% | 18GB | ❌ Terlalu besar |

**Rekomendasi untuk Anda:** **d=64**
- Alasan: 98% performance dengan memory yang feasible untuk T4
- Anda menyarankan d=128, tapi untuk 1500 samples, d=64 sudah cukup
